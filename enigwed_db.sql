...
CREATE TABLE public.tbl_city (
                                 ...
                                 CONSTRAINT tbl_city_pkey PRIMARY KEY (id),
                                 CONSTRAINT ukeh5feh5fgqftlt68m2hn7fjjn UNIQUE (thumbnail_id),
                                 CONSTRAINT fkggl8x1yuehna9rr1juduhuc6l FOREIGN KEY (thumbnail_id) REFERENCES public.tbl_image(id)
);
...
CREATE TABLE public.tbl_wedding_organizer (
                                              ...
                                              CONSTRAINT fkdsgt75ohna1js90ydwl9bao0f FOREIGN KEY (city_id) REFERENCES public.tbl_city(id),
...
CREATE TABLE public.tbl_wedding_package (
                                            ...
                                            CONSTRAINT fk79kd4ios7n66ia8ld37fywsiy FOREIGN KEY (city_id) REFERENCES public.tbl_city(id),
                                            CONSTRAINT fkhh08x91brfg6asyngn553rbki FOREIGN KEY (wedding_organizer_id) REFERENCES public.tbl_wedding_organizer(id)
);


-- public.tbl_wedding_package_image definition

-- Drop table

-- DROP TABLE public.tbl_wedding_package_image;

CREATE TABLE public.tbl_wedding_package_image (
...
-- public.tbl_bonus_package definition

-- Drop table

-- DROP TABLE public.tbl_bonus_package;

CREATE TABLE public.tbl_bonus_package (
                                          id varchar(255) NOT NULL,
                                          created_at timestamp(6) NULL,
                                          deleted_at timestamp(6) NULL,
                                          updated_at timestamp(6) NULL,
                                          ...
                                          wedding_organizer_id varchar(255) NULL,
                                          CONSTRAINT tbl_bonus_package_pkey PRIMARY KEY (id),
                                          CONSTRAINT fk5v56239csdy0s2imk85hq1q20 FOREIGN KEY (wedding_organizer_id) REFERENCES public.tbl_wedding_organizer(id)
);
...
CREATE TABLE public.tbl_order (
                                  ...
                                  CONSTRAINT fk3gb6a3uhqnd6soveh4iu6iubb FOREIGN KEY (wedding_organizer_id) REFERENCES public.tbl_wedding_organizer(id),
                                  CONSTRAINT fkdbbvj4affcu7x13tjn0a12htw FOREIGN KEY (customer_id) REFERENCES public.tbl_customer(id),
                                  CONSTRAINT fkjcvjm2yitvc1ei544e3fhelwg FOREIGN KEY (wedding_package_id) REFERENCES public.tbl_wedding_package(id),
                                  CONSTRAINT fkq3mholvtnk04wlvr4c2yv1ehc FOREIGN KEY (payment_image_id) REFERENCES public.tbl_image(id)
);
...
CREATE TABLE public.tbl_order_detail (
                                         ...
                                         CONSTRAINT fkmr3sw65c4qm4k3j3mes9iqu9f FOREIGN KEY (bonu_package_id) REFERENCES public.tbl_bonus_package(id),
                                         CONSTRAINT fknjncq9emp0cdhj0xbe3kk06h8 FOREIGN KEY (order_id) REFERENCES public.tbl_order(id)
);


-- public.tbl_bonus_package_image definition

-- Drop table

-- DROP TABLE public.tbl_bonus_package_image;

CREATE TABLE public.tbl_bonus_package_image (
                                            ...
                                            CONSTRAINT fkp8tat073kbj9uj91cuoihjgcj FOREIGN KEY (bonus_package_id) REFERENCES public.tbl_bonus_package(id)
);
...
CREATE TABLE public.tbl_bonus_detail (
                                         ...
                                         CONSTRAINT fkoq8wys14igqjm1mvdfb5caeys FOREIGN KEY (bonus_package_id) REFERENCES public.tbl_bonus_package(id)
);
...
INSERT INTO public.tbl_city (id,created_at,deleted_at,updated_at,description,"name",thumbnail_id) VALUES
...
INSERT INTO public.tbl_wedding_organizer (id,created_at,deleted_at,updated_at,address,description,"name",nib,npwp,phone,avatar_id,city_id,user_credential_id) VALUES
...
INSERT INTO public.tbl_bonus_package (id,created_at,deleted_at,updated_at,description,max_quantity,min_quantity,"name",price,wedding_organizer_id) VALUES
...
INSERT INTO public.tbl_wedding_package (id,created_at,deleted_at,updated_at,base_price,description,"name",city_id,wedding_organizer_id,order_count) VALUES
...
INSERT INTO public.tbl_bonus_detail (id,adjustable,quantity,bonus_package_id,wedding_package_id) VALUES
